...
class Game {
    ...
    determineWinner() {
        if (this.player.choice === this.computer.choice) {
            this.winner = 'Draw';
            return '😭 It\s a draw! 😭';
        } else if ((this.player.choice === 'ironMan') && ((this.computer.choice === 'capAm') || (this.computer.choice === 'hulk'))) {
            this.player.wins++;
            this.winner = this.player.name;
            this.player.saveWinsToStorage();
            return  `👩🏻‍💻 ${game.player.name} wins! 👩🏻‍💻`;
        } else if ((this.player.choice === 'capAm') && ((this.computer.choice === 'thor') || (this.computer.choice === 'widow'))) {
            this.player.wins++;
            this.winner = this.player.name;
            this.player.saveWinsToStorage();
            return  `👩🏻‍💻 ${game.player.name} wins! 👩🏻‍💻`;
            ...
            this.player.saveWinsToStorage();
            return  `👩🏻‍💻 ${game.player.name} wins! 👩🏻‍💻`;
        } else if ((this.player.choice === 'hulk') && ((this.computer.choice === 'thor') || (this.computer.choice === 'capAm'))) {
            this.player.wins++;
            this.winner = this.player.name;
            this.player.saveWinsToStorage();
            return  `👩🏻‍💻 ${game.player.name} wins! 👩🏻‍💻`;
